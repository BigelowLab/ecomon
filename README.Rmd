...
Of course, you may be interested in the actual abundance (per m^2 or per 100m^3) for a subset of species. Since there is just one data source at this time, it reads that by default.
